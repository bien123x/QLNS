...
namespace QLNS.Areas.Admin.Controllers
{
    ...
    public class NguoiDungsController : Controller
    {
        ...
        public NguoiDungsController(DbContext_App context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MaNguoiDung,TenDangNhap,MatKhau")] NguoiDung nguoiDung)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaNguoiDung,TenDangNhap,MatKhau")] NguoiDung nguoiDung)
        {
